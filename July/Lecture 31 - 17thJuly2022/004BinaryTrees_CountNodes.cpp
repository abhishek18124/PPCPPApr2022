...
int countNodes(node*  root) {
	...
	// base case
	if(!root) {
		// num. of nodes in an empty tree is zero
		return 0;
	}

	// recursive case

	// 1. ask your friend for the count of nodes in the leftSubtree
	int X = countNodes(root->left);

	// 2. ask your friend for the count of the nodes in the rightSubtree
